...
namespace WSDLTool.Helpers
{
    public class xsd
    {
        ...
        public static string OpenPortType
        {
            get { return "<wsdl:portType"; }
            set { }
        }
        public static string OpenOperationType
        {
            get { return "<wsdl:operation"; }
            set { }
        }
        public static string Openinput
        {
            get { return "<wsdl:input"; }
            set { }
        }
        public static string EndOperationType
        {
            get { return "</wsdl:operation"; }
            set { }
        }
        public static string EndPortType
        {
            get { return "</wsdl:portType"; }
            set { }
        }
